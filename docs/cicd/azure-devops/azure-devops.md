...
This document describes the Azure DevOps workflows for building and analyzing iOS and Android applications.

## iOS Deployment

This workflow builds an iOS application using Xcode.
...
This workflow builds an Android application using Gradle.
